...
//                .requiresChannel().anyRequest().requiresSecure().and()
                ...
                .antMatchers(HttpMethod.DELETE, "/api/articles/{articleId}").permitAll()
                .antMatchers(HttpMethod.GET, "/api/markedArticles").permitAll()
                .antMatchers(HttpMethod.POST, "/api/markedArticles").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/markedArticles/{favoriteArticleId}").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/comments/{articleId}").permitAll()
                .antMatchers(HttpMethod.POST, "/api/comments").permitAll()
                .antMatchers(HttpMethod.DELETE, "/api/comments/{commentId}").permitAll()
